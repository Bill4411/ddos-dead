package main
/data/data/com.termux/files/home/storage/downloads/getblaze-main
...
func get() {
	...
	c := http.Client{
		Timeout: 99999999999999999999 * time.Millisecond,
	}
...
func loop() {
	for {
		go get()
		time.Sleep(0.1 * time.Millisecond) // sleep before sending request again
	}
}
